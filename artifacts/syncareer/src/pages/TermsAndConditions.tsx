...
export default function TermsAndConditions() {
  useEffect(() => { setMetaTags({ title: 'Terms and Conditions — Syncareer', description: 'The rules governing your access to and use of Syncareer.', ogTitle: 'Syncareer Terms and Conditions', ogDescription: 'The rules governing your access to and use of Syncareer.', ogUrl: 'https://syncareer.me/terms', canonical: 'https://syncareer.me/terms' }); }, []);
