...
export const TERMS_SECTIONS = [
  ...
  { id: 'free-service-and-support', title: 'Free Service & Support' },
...
export default function TermsAndConditions() {
  ...
  return <LegalPageLayout document="terms" eyebrow="LEGAL" title="Terms and Conditions" description="The rules governing your access to and use of Syncareer." effectiveDate="1 February 2026" sections={TERMS_SECTIONS}>
    ...
    <LegalSection number={2} {...TERMS_SECTIONS[1]}><p>Syncareer is a career platform that:</p><ul><li>Helps students and recent graduates pursue real opportunities with evidence-based applications</li><li>Is free to use</li><li>Provides AI assistance within career workflows</li></ul><p>Syncareer does not guarantee employment, job placement, or admission into any institution.</p></LegalSection>
    ...
    <LegalSection number={6} {...TERMS_SECTIONS[5]}><p>Syncareer is free to use. All product features are available to all users without payment, and no feature is gated by a paid tier, subscription, or membership.</p><p>Syncareer may offer a voluntary, one-time support option for people who want to help sustain the service. Support is optional, does not create an account tier or status, and never unlocks, extends, or changes access to product features.</p></LegalSection>
