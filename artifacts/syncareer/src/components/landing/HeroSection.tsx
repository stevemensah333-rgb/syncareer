      ...
      <div className="relative mx-auto w-full max-w-[1440px] px-4 pb-14 pt-12 sm:px-6 md:py-16 lg:px-8 lg:pb-28 lg:pt-20">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start lg:gap-8 xl:gap-12">
          <div className="relative z-10 min-w-0 max-w-xl lg:col-span-5 lg:pt-10">
            ...
            <h1 id="landing-hero-title" className="type-display mt-5 text-balance text-[2.6rem] leading-[1.03] sm:text-[3.1rem] lg:text-[3.75rem]">
            ...
            <button type="button" onClick={onAssessment} className="mt-4 inline-flex min-h-11 items-center text-sm font-medium text-muted-foreground underline-offset-4 transition-colors hover:text-foreground hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
