...
export function ContextualAssistantDrawer({ task, title = 'Ask Syncareer', description, context, suggestedPrompt = '', onAccept, onUndo, acceptLabel = 'Accept proposal' }: Props) {
  ...
  return <Sheet>
    ...
    <SheetContent side="right" className="flex w-full flex-col sm:max-w-lg" aria-describedby="assistant-description">
      <SheetHeader><SheetTitle>{title}</SheetTitle><SheetDescription id="assistant-description">{description}</SheetDescription></SheetHeader>
